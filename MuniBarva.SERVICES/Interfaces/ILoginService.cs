...
namespace MuniBarva.SERVICES.Interfaces
{
    public interface ILoginService
    {
        ...
        Task<ApiResponse<string>> Send(SendEmailRecoverPasswordDTO sendEmailRecoverPassword);
        Task<ApiResponse<string>> RecoverPassword(RecoverPasswordDTO recoverPassword);
